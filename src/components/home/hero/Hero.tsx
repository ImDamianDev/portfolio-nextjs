...
export const Hero = () => {
    ...
    return (
        <div id="hero" className='relative min-h-screen flex flex-col-reverse md:flex-row justify-center items-center'>
            ...
            <div className="grid content-center text-center md:text-left p-5 h-fit w-full md:w-auto lg:mr-5 md:-mt-24">
            ...
            <div className='basis-1/4 md:basis-2/4 lg:basis-auto relative flex items-center px-14 md:px-0 -mt-40 md:-mt-24'>
                <Image
            ...
            <div className='absolute w-12 h-20 rounded-full border-3 border-secondary bottom-28'>
